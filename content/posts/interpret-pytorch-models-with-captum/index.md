...
{{< figure src="image.png" alt="Photo of a female Great Hornbill perched on a tree branch surrounded by green leaves and berries, displayed with matplotlib axes showing pixel dimensions" caption="**Figure 1.** A female Great Hornbill used as the test image for model interpretation." >}}
...
{{< figure src="visualization.png" alt="LayerGradCam heatmap visualization overlaid on the Hornbill image, with red regions highlighting the head and beak area that most influenced the model prediction of hornbill" caption="**Figure 2.** LayerGradCam heatmap highlighting the regions that most influenced the prediction." >}}
